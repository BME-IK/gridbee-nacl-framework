 ...
 */
#ifndef PACKAGES_LIBRARIES_NACL_MOUNTS_BASE_MOUNTMANAGER_H_
#define PACKAGES_LIBRARIES_NACL_MOUNTS_BASE_MOUNTMANAGER_H_
...
#endif  // PACKAGES_LIBRARIES_NACL_MOUNTS_BASE_MOUNTMANAGER_H_
